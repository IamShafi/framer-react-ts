const About = () => {
  return (
    <div className='w-full max-w-[1210px] mx-auto flex items-center justify-center flex-col py-[60px]'>
      ...
      <img src="/image/placeholder-image.svg" alt="placeholder-image" className='w-[341px] h-[220px] md:w-[720px] md:h-[464px]'/>
    </div>
  )
}
